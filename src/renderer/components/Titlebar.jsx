            ...
            <Box className={currOs === OS_WINDOWS ? "title-bar title-bar_windows" : "title-bar title-bar_unix"}>
                <div className="tb-controls">
                    ...
                    <Box className={currOs === OS_MAC ? "mac_back" : "tb-cntrl_windows"}
                        ...
                        onClick={() => navigate(-1)}
                    >
                        <Button color={currOs === OS_MAC || currOs === OS_LINUX ? "primary" : "inherit"} sx={{ minWidth: currOs === OS_MAC || currOs === OS_LINUX ? 'inherit' : null }} variant={currOs === OS_MAC || currOs === OS_LINUX ? 'contained' : 'text'}>
