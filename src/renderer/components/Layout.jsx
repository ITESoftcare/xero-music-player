...
import { Grid, ListItem, ListItemIcon, ListItemText, ListSubheader, Switch, useMediaQuery, useTheme } from '@mui/material';
        ...
        <>
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                >
                    ...
                    <List sx={{ p: 1 }}>
                        <ListSubheader sx={{ mt: -2.6 }} inset={open ? false : true}>{APP_NAME} {APP_VERSION}</ListSubheader>
